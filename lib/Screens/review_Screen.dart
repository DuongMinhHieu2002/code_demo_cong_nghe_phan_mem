...
class ScreenReview extends StatefulWidget {
  ...
  const ScreenReview({Key key, this.restaurant}) : super(key: key);
                            ...
                            child: ClipRRect(
                              ...
                              child: Image(
                                ...
                                image: AssetImage(widget
                                    .restaurant.reviews[index].imageUrl
                                    .toString()),
                                fit: BoxFit.cover,
                              ),
                            ),
                            ...
                            child: SizedBox(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                        '${widget.restaurant.reviews[index].name.toString()}\n',
                                        style: const TextStyle(
                                            fontWeight: FontWeight.bold)),
                                    RatingStart(
                                        rating: widget
                                            .restaurant.reviews[index].star),
                                  ],
                                )),
                          )
                        ],
